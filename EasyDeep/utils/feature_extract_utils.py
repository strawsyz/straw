...
def timesformer_extract(data, pretrain_path,output_path):
    output = {}
    # =================模型建立======================
...
if __name__ == '__main__':
    ...
    model_path = r"C:\(lab\PretrainedModel\TimeSFormer\TimeSformer_divST_96x4_224_K400.pyth"
    ...
    out = timesformer_extract(video_path, model_path)
